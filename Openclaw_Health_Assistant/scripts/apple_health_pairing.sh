...
PAIR_URL="mywellwallet://link-mac?host=${HOST}&port=${PORT}&token=${TOKEN}"

echo ""
echo "=== Apple Health / MyWellWallet pairing ==="
echo ""
echo "1. Install MyWellWallet on your iPhone:"
echo "   https://github.com/maheshbalan/myWellWallet"
echo ""
echo "2. On iPhone: open MyWellWallet → Link Mac → scan QR or enter token"
echo ""
...
echo "  APPLE_HEALTH_API_BASE_URL=http://${HOST}:${PORT}"
echo ""
echo "Interim: if QR/API is not in your app build yet, use README Step 5 interim export path."
